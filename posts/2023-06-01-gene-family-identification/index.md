...
例如，植物的共同祖先一般包括藻类及其他绿色植物，而被子植物的共同祖先通常指单双子叶分化之前的阶段。如果从共同祖先定义基因家族，许多已知的基因家族可能会被分成多个基因家族。
...
![](assets/20230601194409.webp)

![](assets/20230601194438.webp)
...
简单来说，就是通过已知的同源基因序列，在算法中进行机器学习后生成一个隐马尔可夫模型，然后我们可以利用这个模型来预测其他物种中是否存在这样的同源基因序列。这样的隐马尔可夫模型其实就是 [pfam](http://pfam-legacy.xfam.org/) 上的以 “.hmm” 为后缀的文件。我们在做基因家族鉴定的时候，用到的 hmmsearch，就必须要求输入这样的 hmm 文件以及基因序列 fasta 文件。
...
基于隐马尔可夫模型在整个水稻基因组的蛋白质序列中查找同源基因
...
![](assets/20230601195521.webp)

然后使用 TBtools 进行可视化

![](assets/20230601195739.webp)
...
![](assets/20230601195838.webp)

然后使用 TBtools 进行可视化

![](assets/20230601195927.webp)

![](assets/20230601195751.webp)
...
![](assets/20230601200515.webp)

比对完成后点击左上角的 Data，选择 Phylogenetic Analysis 进行进化树分析

![](assets/20230601200615.webp)

进化树分析完成后，点击上方 Phylogeny，选择 NJ 算法构建进化树

![](assets/20230601200701.webp)

![](assets/20230601200724.webp)
...
![](assets/20230601200843.webp)

得到分析结果

![](assets/20230601200902.webp)

### 染色体定位分析

![](assets/20230601201108.webp)

得到染色体位置分布图

![](assets/20230601201134.webp)

我们导入重命名文件，使其名称全部变为我们命名的格式

![](assets/20230601201151.webp)

注意重命名文件的格式

![](assets/20230601201453.webp)

可以在这里对颜色和字体进行简单的美化

![](assets/20230601201539.webp)

当然，如果你不想对它们进行统一的更改，可以点击任意一个基因名称，再点击右键对其进行单独的更改，对于染色体的名称也同样适用

调整过后的图就好看了很多

![](assets/20230601201554.webp)
...
![](assets/20230601201651.webp)

![](assets/20230601201710.webp)

### 基因表达量分析

首先在 [Rice Expression Database](http://expression.ic4r.org) 中搜索基因列表

![](assets/20230601201730.webp)

选择 DRP000391 这个项目

![](assets/20230601201742.webp)
...
![](assets/20230601201850.webp)

整理成如下样式

![](assets/20230601202026.webp)

然后对数据进行 LOG2 处理，如果出现#NUM! 字样，全部改为 0

![](assets/20230601202044.webp)

重新整理得到最终数据，打开 TBtools 的 Heat Map 功能，把刚刚整理的数据粘贴进去进行绘图

![](assets/20230601202109.webp)

得到基因家族的表达热图

![](assets/20230601202126.webp)

对基因进行重命名即将复制进去的表格中的基因名称进行修改即可

![](assets/20230601202144.webp)

然后重新制图

![](assets/20230601202157.webp)
...
![](assets/20230601202448.webp)

搜索完成后就得到了蛋白质的互相作用网络

![](assets/20230601202528.webp)

点击每一个圆珠我们就可以查看其信息，包括基因 ID、物种等，圆珠直接的黑色线条表示共表达蛋白质，黄色线条表示在其他生物体中共同提及推定的同源物。

![](assets/20230601202544.webp)
...
![](assets/20230329211727.webp)

下面需要再新建一个关于序列长度的文件，格式如下：

![](assets/20230329211747.webp)

打开 TBtools 的 Simple BioSequence Viewer 功能，导入长度信息文件和元件信息，点击 start 开始

![](assets/20230329211757.webp)

最终得到可视化结果

![](assets/20230329211815.webp)

这是我做的顺式作用元件分析的图，可以对其进行简一些美化

![](assets/20230601202619.webp)
...
![](assets/20230424205736.webp)

这样就得到拟南芥所有基因的共线性分析 Circos 图了

![](assets/20230424205755.webp)
...
![](assets/20230424205834.webp)

然后生成新的关联文件 LinkedRegion

![](assets/20230424205921.webp)

然后将新的 LinkedRegion.txt 文件的内容复制到 Excel 中，最后一列加上 RGB 色值

![](assets/20230424205932.webp)
...
![](assets/20230601202947.webp)

**进化树+Motif+Domain**

![](assets/20230601203017.webp)

**进化树+Motif+Domain+显示外显子、内含子**

![](assets/20230601203035.webp)

**进化树+Motif+Domain+显示外显子、内含子+顺式作用元件**

![](assets/20230601203136.webp)

最终得到一张信息整合的图

![](assets/20230601203149.webp)
