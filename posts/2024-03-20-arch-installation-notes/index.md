...
2020 年，archlinux 安装镜像中加入了 reflector 服务，它会自己更新 mirrorlist。在特定情况下，它会误删某些有用的源信息。进入安装环境后的第一件事就是将其禁用：
...
还可以通过 AUR 安装 Windows 字体，但更推荐直接复制 Windows 的字体文件（.ttf/.ttc）到 Linux 字体目录。
